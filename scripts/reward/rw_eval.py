...
def run_pair_comparison():
    ...
    bad_ans_list = [
        "Microsoft is a large technology company based in Redmond, Washington. It was founded in 1975 by Bill Gates and Paul Allen. Microsoft is known for its software products, including the Windows operating system, Microsoft 365 suite of productivity applications, and the Edge web browser. It also produces hardware products such as the Xbox video game consoles and the Microsoft Surface lineup of touchscreen personal computers. Microsoft is a market leader in the IBM PC compatible operating system market and the office software suite market. Microsoft 365 is a cloud-powered productivity platform that includes the Office desktop apps like Word, PowerPoint, and Excel, as well as extra online storage and cloud-connected features that let you collaborate on files in real-time. Microsoft Teams is a messaging app for organizations that provides a workspace for real-time collaboration and communication, meetings, file and app sharing, and more.",
